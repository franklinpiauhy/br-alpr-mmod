# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 00:32:37 2019
...
if len(sys.argv) != 2:
    ...
    exit()
plates_folder = sys.argv[1]'''
plates_folder = 'D:\\UFPR-ALPR detection dataset\\training\\'
...
# data.
options.add_left_right_image_flips = False # False for plates
...
training_xml_path = os.path.join(plates_folder, "plate_training.xml")
...
# dlib.
dlib.train_simple_object_detector(training_xml_path, "plate_detector.svm", options)
...
print("Training accuracy: {}".format(
    dlib.test_simple_object_detector(training_xml_path, "plate_detector.svm")))
